        ...
        <div className="w-full md:w-1/2 p-8 flex flex-col justify-center items-center">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Track your development activity and get recognized for your
              contributions
            </p>
          </div>
          ...
          <div className="mt-6 text-xs text-gray-500 text-center max-w-sm">
            <p>
              By signing up, you agree to connect your GitHub account and allow
              us to track your repository activity for recognition and analytics
              purposes.
            </p>
          </div>
        </div>
